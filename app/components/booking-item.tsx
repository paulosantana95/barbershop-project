...
import { cancelBooking } from "../actions/cancel-bookings";
...
const BookingItem = ({ booking }: BookingItemProps) => {
  ...
  const handleCancelClick = async () => {
    ...
    try {
      ...
      toast.success("Reserva foi cancelada com sucesso!");
    } catch (error) {
      console.error(error);
    } finally {
        ...
        <div className="px-5">
          ...
          <SheetFooter className="flex-row gap-3 mt-6">
            ...
            <AlertDialog>
              ...
              <AlertDialogContent className="w-[70%] rounded-md">
                <AlertDialogHeader>
                  <AlertDialogTitle>Cancelar essa Reserva?</AlertDialogTitle>
                  <AlertDialogDescription className="pt-2 pb-6">
